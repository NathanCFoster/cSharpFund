...
class SinglyLinkedList {
    ...
    hasLoop() {
        ...
        while (runner) {
            while (fastRunner) {
                if (runner.next === fastRunner.next && fastRunner != runner) {
                    return true;
                }
...
var sll = new SinglyLinkedList().seedFromArr([5,4,3,2,-11]).removeNegatives();
console.log(sll.toArr() + sll.hasLoop());