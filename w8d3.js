...
class Queue {
     ...
     */
    compareQueues(q2) {
        return (q2.print() == this.print() ? true : false);
    }
     ...
     */
    isPalindrome() {
        let reversedArray = [...this.items];
        let stack = new Queue(reversedArray.reverse());
        return this.compareQueues(stack);
    }
}

var tempQue = new Queue([4,3,2,1]);

var que = new Queue([4,2,3,2,4]);
console.log(que.compareQueues(tempQue));
console.log(que.isPalindrome());